...
<add key="Cnn" value="Data Source=MSDEVSVR;Initial Catalog=DATABASE;Persist Security Info=True;User ID=sa;Password=SQL2014$$; Min Pool Size=5;Max Pool Size=200;Connect Timeout=600;MultipleActiveResultSets=True;" />
<add name="Cnn" connectionString="Data Source=USER-PC\SQL2014;Initial Catalog=Credit;Persist Security Info=True;User ID=sa;Password=sql2014;Min Pool Size=5;Max Pool Size=1000;Connect Timeout=6000;Connection Lifetime=120;Connection Reset=true;MultipleActiveResultSets=True;" providerName="System.Data.SqlClient" />

<add name="BlogEngine" connectionString="Server=DESKTOP-AF7JH3R\MSSQLSERVER2014;Database=BlogEngine;Trusted_Connection=True;" providerName="System.Data.SqlClient" />
